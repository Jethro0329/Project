...
<header class="bg-gray-800 text-white fixed top-0 left-0 right-0 z-50">
    <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul class="flex space-x-6">
            ...
            <li><a href="{{ url('/content') }}" class="hover:text-gray-400">Content</a></li>
        </ul>
    </nav>
</header>

    <main class="pt-20"> <!-- Adds padding-top to push content below the fixed navbar -->
        <div class="min-h-screen bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900">
            <div class="container mx-auto px-4 py-8">
                <h1 class="text-4xl font-semibold text-black dark:text-white text-center">Gallery of Games</h1>
                <p class="text-xl mt-4 text-black dark:text-white/70 text-center">Explore our curated selection of games.</p>
                
                <div class="game-gallery">
                    <!-- Game 1 -->
                    <div class="game-item">
                        <div class="game-image-1">
                            <img src="{{ asset('img/gtav.jpg') }}" alt="Game 1" class="game-img">
                        </div>
                    ...
                    <div class="game-item">
                        ...
                        <div class="game-image-2">
                        <img src="{{ asset('img/valo.jpg') }}" alt="Game 2" class="game-img">
                        </div>
                    </div>

                    <!-- Game 3 -->
                    <div class="game-item">
                        <div class="game-image-3">
                        <img src="{{ asset('img/re4.jpg') }}" alt="Game 3" class="game-img">
                        </div>
                        <div class="game-description">
